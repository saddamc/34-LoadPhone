...
const displayPhones = (phones, isShowAll) =>{
    // console.log(phones);
    // 1. add html div container
    const phoneContainer = document.getElementById('phone-container');
    // clear phone container cards before adding new cards
    phoneContainer.textContent = '';  /**.textContent / .innerText / .innerHTML is same */
    ...
    phones.forEach(phone =>{
        ...
        <div class="card-body">
            <h3 class="font-semibold">${phone.brand}</h3>
            <h2 class="card-title">${phone.phone_name}</h2>
            <p>${phone.slug}</p>
            <div class="card-actions justify-center">
            <button onclick="handleShowDetails('${phone.slug}'); show_details_modal.showModal()" 
...
const handleShowDetails = async (id) => {
    // console.log('click on showDetails', id)
